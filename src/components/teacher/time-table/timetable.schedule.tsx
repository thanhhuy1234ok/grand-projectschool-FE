import { getScheduleTimeTableStudentAPI, getScheduleTimeTableTeacherAPI } from "@/services/api";
...
const TimeTable = () => {
    ...
    const timeSlots = [
        { label: 'Morning', start: '05:00:00', end: '12:00:00' },
    ...
    const fetchSchedule = async () => {
        const res = await getScheduleTimeTableTeacherAPI();
    ...
    const renderScheduleCell = (day: string, slot: { start: string; end: string }) => {
        const filteredSchedules = scheduleData.filter((schedule) =>
            ...
            dayjs(schedule.startTime, "HH:mm:ss").format("HH:mm") >= slot.start &&
            dayjs(schedule.endTime, "HH:mm:ss").format("HH:mm") <= slot.end
        );
    ...
    return (
        <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
            <h1 style={{ textAlign: 'center' }}>Lich day </h1>
